...
public class AdminAccountGenerationFrame extends javax.swing.JFrame {
    ...
    private void reportLabelMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        projectManagerController controller = new projectManagerController(propertyInfo, new MyJFrame());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(same == false){
            User temp = new User(userInfo.size() + 1,txtField1.getText(),txtField2.getText(),"None","None","None","Admin","Approved");
