...
public class PropertyManagerHomePage extends JPanel{
	...
	private JComboBox<String> activationStatusCombobox;
	private JLabel minRentRateLabel;
	private JLabel maxRentRateLabel;
	private JComboBox<String> maxRentalRateCombobox;
	...
	private JCheckBox[] facilitiesCheckboxList = new JCheckBox[7];
...
//			add(panel); TODO return if something went wrong in home
